...
def init_default_params(nparams):
    ...
    # SOIL PARAMETERS (Set to zero for hydroponics)
    params[27] = 0.0;          # hSo1; Thickness of soil layer 1 [m]
    params[28] = 0.0;          # hSo2; Thickness of soil layer 2 [m]
    params[29] = 0.0;          # hSo3; Thickness of soil layer 3 [m]
    params[30] = 0.0;          # hSo4; Thickness of soil layer 4 [m]
    params[31] = 0.0;          # hSo5; Thickness of soil layer 5 [m]
    ...
    params[114] = 0.0;         # capSo1; Heat capacity of soil layer 1 [J m-2 K-1]
    params[115] = 0.0;         # capSo2; Heat capacity of soil layer 2 [J m-2 K-1]
    params[116] = 0.0;         # capSo3; Heat capacity of soil layer 3 [J m-2 K-1]
    params[117] = 0.0;         # capSo4; Heat capacity of soil layer 4 [J m-2 K-1]
    params[118] = 0.0;         # capSo5; Heat capacity of soil layer 5 [J m-2 K-1]
    ...
    params[208] = 0.8;          # hydroNutrientConcentration; Nutrient concentration in the hydroponic solution [g/L]
    params[209] = 25.;          # hydroSolutionTemp; Temperature of the hydroponic solution [°C]
    params[210] = 6.0;          # hydroPH; pH level of the hydroponic solution []
    params[211] = 0.02;         # hydroFlowRate; Flow rate of the hydroponic solution [L/s]
    params[212] = 0.85;         # hydroOxygenLevel; Dissolved oxygen level in the hydroponic solution [mg/L]
    params[213] = 0.9;          # hydroLightUtilization; Light utilization efficiency in hydroponics []
...
def init_state(d0, rhMax=90, time_in_days=0):
    ...
    state = np.zeros(30)  # Adjusted size for hydroponic-specific states
    ...
    state[28] = 0.8;       # nutrientConcentration; Initial nutrient concentration in the solution [g/L]
    state[29] = 25.;       # solutionTemp; Initial temperature of the hydroponic solution [°C]
